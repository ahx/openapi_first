...
class Weather::TemperatureControllerTest < ActionDispatch::IntegrationTest
  # def openapi_first_default_api = :weather
  include OpenapiFirst::Test::Methods[TrainTravel::Application, api: :weather]
  ...
  test "it returns temperature data for given latitude and longitude" do
    ...
    assert_equal "53.5", json_response["temperature"]["fahrenheit"]
  end
end
